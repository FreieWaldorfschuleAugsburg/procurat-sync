package de.waldorfaugsburg.syncer.client.starface;
...
import de.waldorfaugsburg.syncer.client.starface.exception.StarfaceLoginException;
import de.waldorfaugsburg.syncer.client.starface.model.*;
import de.waldorfaugsburg.syncer.client.starface.service.StarfaceService;
...
public final class StarfaceClient extends AbstractHttpClient {
    ...
    StarfaceClient(final SyncerApplication application) {
    ...
    public static StarfaceClient createInstance(final SyncerApplication application) throws StarfaceLoginException, HttpClientException {
