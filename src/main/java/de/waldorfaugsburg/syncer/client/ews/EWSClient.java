package de.waldorfaugsburg.syncer.client.ews;
...
public final class EWSClient extends AbstractClient {
    ...
    EWSClient(final SyncerApplication application) {
    ...
    public static EWSClient createInstance(final SyncerApplication application) throws Exception {
