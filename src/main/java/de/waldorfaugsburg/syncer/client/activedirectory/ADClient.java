...
import de.waldorfaugsburg.syncer.client.AbstractClient;
...
public final class ADClient extends AbstractClient {
    ...
    ADClient(final SyncerApplication application) {
        this.application = application;
    }

    public static ADClient createInstance(final SyncerApplication application) throws NamingException {
