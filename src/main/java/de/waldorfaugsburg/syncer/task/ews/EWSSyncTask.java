...
import de.waldorfaugsburg.syncer.client.ews.EWSClient;
...
public final class EWSSyncTask extends AbstractSyncTask<EWSSyncTaskConfiguration> {
    ...
    public EWSSyncTask(final SyncerApplication application, final EWSSyncTaskConfiguration configuration) {
