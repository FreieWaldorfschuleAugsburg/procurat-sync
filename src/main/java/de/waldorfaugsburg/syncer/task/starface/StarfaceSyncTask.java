...
import de.waldorfaugsburg.syncer.client.starface.StarfaceClient;
...
public final class StarfaceSyncTask extends AbstractSyncTask<StarfaceSyncTaskConfiguration> {
    ...
    public StarfaceSyncTask(final SyncerApplication application, final StarfaceSyncTaskConfiguration configuration) {
