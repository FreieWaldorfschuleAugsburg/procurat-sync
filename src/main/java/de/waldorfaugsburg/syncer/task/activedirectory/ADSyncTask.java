package de.waldorfaugsburg.syncer.task.activedirectory;
...
import de.waldorfaugsburg.syncer.client.activedirectory.ADClient;
import de.waldorfaugsburg.syncer.client.activedirectory.model.ADUser;
...
public final class ADSyncTask extends AbstractSyncTask<ADSyncTaskConfiguration> {
    ...
    public ADSyncTask(final SyncerApplication application, final ADSyncTaskConfiguration configuration) {
