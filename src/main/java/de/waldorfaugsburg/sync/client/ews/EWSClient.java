package de.waldorfaugsburg.sync.client.ews;
...
public final class EWSClient extends AbstractClient {
    ...
    EWSClient(final SyncApplication application) {
    ...
    public static EWSClient createInstance(final SyncApplication application) throws Exception {
