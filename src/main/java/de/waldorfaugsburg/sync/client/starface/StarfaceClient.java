package de.waldorfaugsburg.sync.client.starface;

import de.waldorfaugsburg.sync.SyncApplication;
import de.waldorfaugsburg.sync.client.AbstractHttpClient;
import de.waldorfaugsburg.sync.client.HttpClientException;
import de.waldorfaugsburg.sync.client.starface.exception.StarfaceLoginException;
import de.waldorfaugsburg.sync.client.starface.model.*;
import de.waldorfaugsburg.sync.client.starface.service.StarfaceService;
...
public final class StarfaceClient extends AbstractHttpClient {
    ...
    StarfaceClient(final SyncApplication application) {
    ...
    public static StarfaceClient createInstance(final SyncApplication application) throws StarfaceLoginException, HttpClientException {
