package de.waldorfaugsburg.sync.client.procurat;
...
import de.waldorfaugsburg.sync.module.procurat.service.*;
...
public final class ProcuratClient extends AbstractHttpClient {
    ...
    ProcuratClient(final SyncApplication application) {
    ...
    public static ProcuratClient createInstance(final SyncApplication application) throws HttpClientException {
