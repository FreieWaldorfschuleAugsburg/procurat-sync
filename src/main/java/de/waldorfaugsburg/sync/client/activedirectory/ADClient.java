package de.waldorfaugsburg.sync.client.activedirectory;

import com.cronutils.utils.Preconditions;
import de.waldorfaugsburg.sync.SyncApplication;
import de.waldorfaugsburg.sync.client.AbstractClient;
...
public final class ADClient extends AbstractClient {
    ...
    ADClient(final SyncApplication application) {
        this.application = application;
    }

    public static ADClient createInstance(final SyncApplication application) throws NamingException {
